...
require_once __DIR__ . '/controllers/matchesFinBetHandler.php';
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') :
    ...
    if(isset($_GET['id'])){
        ...
        $id = $_GET['id'];
        $sql = "SELECT * FROM `matches_fin_bet` WHERE `id`='$id' AND `user_id`='$loggedUserId'";
        ...
        $sql = "SELECT * FROM `matches_fin_bet` WHERE `user_id`='$loggedUserId'";
        $query = mysqli_query($connection, $sql);
